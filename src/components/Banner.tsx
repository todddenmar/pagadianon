...
function Banner() {
  return (
    <div className="h-[600px] w-full flex flex-col items-center justify-center relative bg-black overflow-hidden">
      <div
        className=" bg-cover bg-center inset-0 absolute opacity-35"
      ...
      ></div>
      <div className="flex text-white text-center flex-col items-center z-20 p-2 md:p-5 max-w-full">
