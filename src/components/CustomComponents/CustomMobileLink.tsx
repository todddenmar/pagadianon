  ...
  return (
    <div className="flex gap-2 items-center rounded-full bg-neutral-200 dark:bg-neutral-950 p-1 pr-2">
      <a
        ...
        className="flex gap-2 items-center bg-white hover:bg-neutral-100 transition-all dark:text-black w-fit pl-2 pr-3 py-2 rounded-full font-semibold capitalize"
      >
        {children}
      </a>
      <CustomCopyButton
